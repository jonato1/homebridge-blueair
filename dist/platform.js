...
exports.BlueAirHomebridgePlatform = void 0;
 ...
 */
class BlueAirHomebridgePlatform {
    ...
    async discoverDevices() {
        // get homehost
        const flag = await this.blueair.getHomehost();
        if (!flag) {
    ...
    optionEnabled(device, defaultReturnValue = true) {
